...
App with mercadolibre integration.
List all products end select 10 to indexpage
...
Fetching: mercadolibre-0.8.7.gem (100%)
Successfully installed mercadolibre-0.8.7
Parsing documentation for netrc-0.11.0
Installing ri documentation for netrc-0.11.0
Parsing documentation for mime-types-2.99.2
Installing ri documentation for mime-types-2.99.2
...
Parsing documentation for mercadolibre-0.8.7
Installing ri documentation for mercadolibre-0.8.7
Done installing documentation for netrc, mime-types, unf_ext, unf, domain_name, http-cookie, rest-client, mercadolibre after 8 seconds
